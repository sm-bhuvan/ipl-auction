...
const CSKRetentions2025 = () => {
  ...
  const selectedPlayers = [
    { name: "Ruturaj Gaikwad", type: "capped", amount: 18, category: "Batsman" },
    { name: "Ravindra Jadeja", type: "capped", amount: 18, category: "All-Rounder" },
    { name: "Matheesha Pathirana", type: "overseas", amount: 13, category: "Fast Bowler" },
    { name: "Shivam Dube", type: "capped", amount: 12, category: "All-Rounder" },
    { name: "MS Dhoni", type: "uncapped", amount: 4, category: "Wicket-Keeper" }
  ];
