...
const GTRetentions2025 = () => {
  const selectedPlayers = [
    ...
    { name: "Rashid Khan", type: "capped", amount: 18, category: "All-Rounder", role: "Vice-Captain" },
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-blue-50 p-4">
      <div className="max-w-7xl mx-auto h-full flex flex-col">
        ...
        <div className="text-center mb-4">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-black bg-gradient-to-r from-yellow-600 via-orange-500 to-blue-600 bg-clip-text text-transparent">
                IPL 2025 - Gujarat Titans
              </h1>
              <div className="flex items-center justify-center gap-2 mt-1">
                <Crown className="w-4 h-4 text-yellow-600" />
                <span className="text-sm font-medium text-gray-700">Captain: Shubman Gill</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100 h-full">
              ...
              <div className="grid grid-cols-1 gap-3 h-full overflow-y-auto">
                {selectedPlayers.map((player, index) => (
                  <div key={player.name} className="group bg-gray-50 rounded-xl p-4 border border-gray-200 hover:border-yellow-300 hover:shadow-md transition-all">
