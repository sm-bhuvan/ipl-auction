...
const RCBRetentions2025 = () => {
  ...
  const selectedPlayers = [
    { name: "Virat Kohli", type: "capped", amount: 21, category: "Batsman" },
    { name: "Rajat Patidar", type: "capped", amount: 11, category: "Batsman" },
    { name: "Yash Dayal", type: "uncapped", amount: 5, category: "Fast Bowler" }
  ];
