...
const DCRetentions2025 = () => {
  ...
  const getCategoryIcon = (category) => {
    switch(category) {
      ...
      case "Spin Bowler": return <Zap className="w-3 h-3" />;
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-red-50 to-purple-50 p-4">
      <div className="max-w-7xl mx-auto h-full flex flex-col">
        ...
        <div className="text-center mb-4">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-black bg-gradient-to-r from-blue-600 via-red-500 to-purple-600 bg-clip-text text-transparent">
                IPL 2025 - Delhi Capitals
              </h1>
              <div className="flex items-center justify-center gap-2 mt-1">
                <Crown className="w-4 h-4 text-blue-600" />
                <span className="text-sm font-medium text-gray-700">Captain: Axar Patel</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-span-3 space-y-3">
            <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
              ...
              <div className="space-y-2">
                ...
                <SummaryRow label="RTM Cards" value="2 Available" color="indigo" />
              </div>
            </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-red-500 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
                            {index + 1}
                          </div>
                          {player.role === "Captain" && (
