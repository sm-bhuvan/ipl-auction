...
const KKRRetentions2025 = () => {
  ...
  const totalAmount = selectedPlayers.reduce((sum, p) => sum + p.amount, 0);
  ...
  const getCategoryIcon = (category) => {
    if (category.includes("Batsman")) return <Target className="w-3 h-3" />;
    if (category.includes("All‑Rounder")) return <Star className="w-3 h-3" />;
    if (category.includes("Fast Bowler")) return <Zap className="w-3 h-3" />;
    if (category.includes("Spin Bowler")) return <Shield className="w-3 h-3" />;
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-purple-50 via-yellow-50 to-white p-4">
      <div className="max-w-7xl mx-auto h-full flex flex-col">
        ...
        <div className="text-center mb-4">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-black bg-gradient-to-r from-purple-700 via-yellow-500 to-indigo-600 bg-clip-text text-transparent">
                IPL 2025 - Kolkata Knight Riders
              </h1>
              <div className="flex items-center justify-center gap-2 mt-1">
                <Crown className="w-4 h-4 text-purple-700" />
                <span className="text-sm font-medium text-gray-700">Captain: To be announced</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-span-3 space-y-3">
            <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
              ...
              <div className="space-y-2">
                <SummaryRow label="Players Retained" value={`${totalPlayers}/6`} color="yellow" />
          ...
          <div className="col-span-9">
            <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100 h-full">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-yellow-500 rounded-full flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 gap-3 h-full overflow-y-auto">
                {selectedPlayers.map((player, index) => (
                  <div key={player.name} className="group bg-gray-50 rounded-xl p-4 border border-gray-200 hover:border-purple-400 hover:shadow-md transition-all">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-yellow-400 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
                            {index + 1}
                          </div>
                        </div>
                        <div>
