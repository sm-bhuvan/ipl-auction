...
const PBKSRetentions2025 = () => {
  const selectedPlayers = [
    { name: "Shashank Singh", type: "uncapped", amount: 5.5, category: "All-Rounder", role: "Finisher" },
    { name: "Prabhsimran Singh", type: "uncapped", amount: 4, category: "Wicket-Keeper", role: "Opener" },
    { name: "Arshdeep Singh", type: "capped", amount: 12, category: "Fast Bowler", role: "Death Bowler" }
  ];
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-red-50 via-white to-yellow-50 p-4">
      <div className="max-w-7xl mx-auto h-full flex flex-col">
        ...
        <div className="text-center mb-4">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-black bg-gradient-to-r from-red-600 via-yellow-500 to-yellow-700 bg-clip-text text-transparent">
          ...
          <div className="col-span-3 space-y-3">
            <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
              ...
              <div className="space-y-2">
                <SummaryRow label="Players Retained" value={`${totalPlayers}/6`} color="red" />
                ...
                <SummaryRow label="RTM Cards" value="3 Available" color="indigo" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100 h-full">
              ...
              <div className="grid grid-cols-1 gap-3 h-full overflow-y-auto">
                {selectedPlayers.map((player, index) => (
                  <div key={player.name} className="group bg-gray-50 rounded-xl p-4 border border-gray-200 hover:border-red-400 hover:shadow-md transition-all">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <div className="w-10 h-10 bg-gradient-to-br from-red-500 to-yellow-500 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
                            {index + 1}
                          </div>
                        </div>
                        <div>
