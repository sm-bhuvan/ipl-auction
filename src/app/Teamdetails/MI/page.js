...
const MIRetentions2025 = () => {
  // Actual Mumbai Indians IPL 2025 retentions
  const selectedPlayers = [
    { name: "Jasprit Bumrah", type: "capped", amount: 18, category: "Fast Bowler" },
    { name: "Suryakumar Yadav", type: "capped", amount: 16.35, category: "Batsman" },
    { name: "Hardik Pandya", type: "capped", amount: 16.35, category: "All-Rounder" },
    { name: "Rohit Sharma", type: "capped", amount: 16.30, category: "Batsman" },
    { name: "Tilak Varma", type: "capped", amount: 8, category: "Batsman" }
  ];
  ...
  const remainingPurse = 45; // As per search results
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 font-medium">Mumbai Indians - Final List</p>
          <p className="text-sm text-gray-500 mt-2">Captain: Hardik Pandya</p>
        </div>
        ...
        <div className="mb-8 bg-gradient-to-r from-gray-50 to-slate-100 border-2 border-gray-200 rounded-2xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
            ...
            <div className="bg-white rounded-xl p-4 text-center shadow-sm">
              ...
              <p className="text-2xl font-bold text-green-600">₹{totalAmount.toFixed(2)} cr</p>
            </div>
            <div className="bg-white rounded-xl p-4 text-center shadow-sm">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-2xl p-6 shadow-lg">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h4 className="text-2xl font-bold text-blue-800">Retained Players</h4>
          </div>
          
          <div className="grid gap-4">
            {selectedPlayers.map((player, index) => (
              <div key={player.name} className="bg-white rounded-xl p-6 shadow-md border-l-4 border-blue-500 hover:shadow-lg transition-shadow">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-3 text-sm text-gray-600 mt-1">
                        <span className="px-2 py-1 bg-blue-100 rounded-full font-medium">{player.category}</span>
                        <span className="px-2 py-1 bg-purple-100 rounded-full font-medium capitalize">{player.type}</span>
                      </div>
                    </div>
                  </div>
