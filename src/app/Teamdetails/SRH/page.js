...
const SRHRetentions2025 = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-orange-50 via-white to-black/5 p-4">
      <div className="max-w-7xl mx-auto h-full flex flex-col">
        ...
        <div className="text-center mb-4">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-black bg-gradient-to-r from-orange-600 via-black to-black bg-clip-text text-transparent">
                IPL 2025 - Sunrisers Hyderabad
              </h1>
              <div className="flex items-center justify-center gap-2 mt-1">
                <Crown className="w-4 h-4 text-orange-600" />
                <span className="text-sm font-medium text-gray-700">Captain: Pat Cummins</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-span-3 space-y-3">
            <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
              ...
              <div className="space-y-2">
                <SummaryRow label="Players Retained" value={`${totalPlayers}/6`} color="orange" />
                ...
                {rules.map((rule, index) => (
                  <div key={index} className="bg-gray-50 rounded-lg p-2 border border-gray-200">
                    <div className="flex items-center gap-2 mb-1">
                      <div className="w-6 h-6 bg-black/10 rounded-full flex items-center justify-center text-black">
                        {rule.icon}
                      </div>
          ...
          <div className="col-span-9">
            <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100 h-full">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-gradient-to-r from-orange-500 to-black rounded-full flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 gap-3 h-full overflow-y-auto">
                {selectedPlayers.map((player, index) => (
                  <div key={player.name} className="group bg-gray-50 rounded-xl p-4 border border-gray-200 hover:border-orange-400 hover:shadow-md transition-all">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-black rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
                            {index + 1}
                          </div>
                          {player.role === "Captain" && (
